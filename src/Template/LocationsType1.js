...
import locationsTypeOneCss from '../css/locations_type1.module.scss'
...
const LocationsType1 = ({ bannerImg, locationIndex, imgsAll, imgsToShow, title, description, tips, moreAboutThere, coverImg, prevImg, nextImg, coverImgPosition, prevLink, nextLink }) => {
        ...
        <div className={locationsTypeOneCss.locations_type_1_container}>
          ...
          <div>
            ...
            <div className={locationsTypeOneCss.bannerImg_container} data-aos="fade-in">
              <motion.img src={bannerImg} style={{ objectPosition: coverImgPosition }} className={locationsTypeOneCss.bannerImg_prop} />
            </div>
          </div>
          ...
          <div className={locationsTypeOneCss.body_container} data-aos="fade-in">
