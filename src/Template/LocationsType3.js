...
import locationsTypeThreeCss from '../css/locations_type3.module.scss'
...
const LocationsType3 = ({ bannerImg, locationIndex, imgsAll, imgsToShow, title, description, tips, moreAboutThere, coverImg, prevImg, nextImg, prevLink, nextLink }) => {
  ...
  */
  ...
  var imgRender = imgsToShow.map(item => <div className={locationsTypeThreeCss.img_sep_container}><motion.img src={item} className={locationsTypeThreeCss.img_prop} /></div>);
  ...
  return (
    <LocationPageLayout>
      <section id={locationsTypeThreeCss.locations_type_3}>
        <div className={locationsTypeThreeCss.locations_type_3_container}>
          <Navbar data-aos="fade-in" />

          <div className={locationsTypeThreeCss.index_container} data-aos="fade-in">
            <span className={locationsTypeThreeCss.index_prop}>{locationIndex}</span>
          </div>

          <div className={locationsTypeThreeCss.body_container} data-aos="fade-in">
            <div className={locationsTypeThreeCss.title_container}>
              {titleRender}
            </div>
            <div className={locationsTypeThreeCss.description_container}>
              {descriptionRender}
            </div>
          </div>

          <div className={locationsTypeThreeCss.img_container} data-aos="fade-in">
            {imgRender}
          </div>
